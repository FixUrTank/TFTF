CREATE TABLE users(
    user_uid int(5) NOT NULL PRIMARY KEY,
...
CREATE TABLE tours(
    ...
    tour_guide_id REFERENCES (tourguides)tour_guide_id FOREIGN KEY
);

CREATE TABLE receipt(
    receipt_id int(5) NOT NULL,
    user_uid REFERENCES (users)user_uid FOREIGN KEY,
    vehicle_id REFERENCES (vehicles)vehicle_id FOREIGN KEY,
    tour_guide_id REFERENCES (tourguides)tour_guide_id FOREIGN KEY,
);
